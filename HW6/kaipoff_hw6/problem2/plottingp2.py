...
partc = pd.read_csv("p2partc.csv")
partd = pd.read_csv("p2partd.csv")
...
axs[0].set_title("Time vs Number of Processes in Computing an Integral")
...
axs[1].set_title("Numerical Error vs. Number of Partition Points in Computing an Integral (1 process)")
